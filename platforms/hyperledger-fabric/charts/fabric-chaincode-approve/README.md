...
| images.alpineutils    | Provide the valid image name and version to read certificates from vault server   | alpineUtils: ghcr.io/hyperledger/bevel-alpine:latest          |
